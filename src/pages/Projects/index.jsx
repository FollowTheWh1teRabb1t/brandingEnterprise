...
export default function Projects() {
    ...
    return(
        <Container>
            ...
            <div className='boxProject'>
            <img src={P2}/>
                <a href='https://sorveteria-omega.vercel.app/' target="_blank"  rel="noopener noreferrer">Link para o projeto! </a>
                <h1>Sorveteria</h1>
                <div className='boxDifficult'>
                <h2>Dificuldade:</h2>
                    {renderStars(2)}
            ...
            <div className='boxProject'>
                <img src={P4}/>
                <a href='https://loja-de-oculus-2cxhx2eyn-felipe-jose-de-limas-projects.vercel.app/' target="_blank"  rel="noopener noreferrer">Link para o projeto! </a>
                <h1>Ótica</h1>
                <div className='boxDifficult'>
                <h2>Dificuldade:</h2>
                    {renderStars(2)}
            ...
            <div className='boxProject'>
                <img src={P6}/>
                <a href='https://branding-enterprise-git-master-felipe-jose-de-limas-projects.vercel.app/' target="_blank"  rel="noopener noreferrer">Link para o projeto! </a>
